...
const WHATSAPP_NUMBER = "5493513345967"; // Replace with actual number
const WHATSAPP_MESSAGE = "Hola! Me interesa conocer más sobre los servicios de Lupyx Talent.";
...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      onClick={() => track.contactClick("whatsapp-float")}
